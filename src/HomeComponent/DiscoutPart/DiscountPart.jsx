          ...
          <Flex className={"items-center justify-between"}>
            <div className="w-1/2">
              <div>
                ...
                <h3 className="font-Josefin font-bold text-sm text-BtnColor mt-2">
                  Eams Sofa Compact
                </h3>
                <p className="font-Lato font-normal text-sm text-OpacityColor w-[500px] mt-4">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu
                  eget feugiat habitasse nec, bibendum condimentum.
                </p>
                <div className="flex flex-col gap-y-3 mt-6">
                  <div className="flex items-center grow shrink gap-x-4">
                    <div className="flex items-center gap-x-2">
                      <IoMdCheckmark className="font-Lato font-normal text-sm text-OpacityColor"/>
                      <h3  className="font-Lato font-normal text-sm text-OpacityColor">Material expose like metals</h3>
                    </div>
                    <div className="flex items-center gap-x-2">
                      <IoMdCheckmark className="font-Lato font-normal text-sm text-OpacityColor"/>
                      <h3 className="font-Lato font-normal text-sm text-OpacityColor">Clear lines and geomatric figures</h3>
                    </div>
                  </div>
                  <div className="flex items-center shrink grow  gap-x-10">
                    <div className="flex items-center gap-x-2">
                      <IoMdCheckmark className="font-Lato font-normal text-sm text-OpacityColor"/>
                      <h3 className="font-Lato font-normal text-sm text-OpacityColor">Simple neutral colours.</h3>
                    </div>
                    <div className="flex items-center gap-x-2">
                      <IoMdCheckmark className="font-Lato font-normal text-sm text-OpacityColor"/>
                      <h3 className="font-Lato font-normal text-sm text-OpacityColor">Material expose like metals</h3>
              ...
              <div className="py-8"> 
                <button className="px-10 py-2 bg-BtnColor text-CommonColor font-Josefin">Shop Now</button>
              </div>
            </div>
            <div className="w-1/2">
